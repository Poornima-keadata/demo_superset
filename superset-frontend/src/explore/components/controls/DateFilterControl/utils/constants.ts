...
export const FRAME_OPTIONS: SelectOptionType[] = [
  ...
  { value: 'Calendar', label: t('Current') },
  { value: 'Custom', label: t('Time Range') },
...
export const CALENDAR_RANGE_OPTIONS: SelectOptionType[] = [
  { value: PreviousCalendarDay, label: t('current day') },
  { value: PreviousCalendarWeek, label: t('current week') },
  {
...
//   { value: CurrentDay, label: t('This day') },
//   { value: CurrentWeek, label: t('This week') },
//   {
//     value: CurrentMonth,
//     label: t('This month'),
//   },
...
// export const CURRENT_CALENDAR_VALUES_SET = new Set(
...
export const CURRENT_CALENDAR_RANGE_SET: Set<CalendarRangeType> = new Set([
  CurrentDay,
  CurrentWeek,
  CurrentMonth,
  CurrentYear,
